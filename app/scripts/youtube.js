...
(function() {
    ...
    function B() {
        return -1 != A.indexOf("Edge")
    };
    var ma = -1 != A.indexOf("Opera") || -1 != A.indexOf("OPR"),
        C = -1 != A.indexOf("Edge") || -1 != A.indexOf("Trident") || -1 != A.indexOf("MSIE"),
        D = -1 != A.indexOf("Gecko") && !(-1 != A.toLowerCase().indexOf("webkit") && !B()) && !(-1 != A.indexOf("Trident") || -1 != A.indexOf("MSIE")) && !B(),
        na = -1 != A.toLowerCase().indexOf("webkit") && !B();

    function oa() {
        var a = A;
        if (D) return /rv\:([^\);]+)(\)|;)/.exec(a);
        if (C && B()) return /Edge\/([\d\.]+)/.exec(a);
    ...
    var qa = function() {
        ...
        var a = "",
            b = oa();
        b && (a = b ? b[1] : "");
        return C && !B() && (b = pa(), b > parseFloat(a)) ? String(b) : a
    }(),
        ra = {};

    function sa(a) {
        if (!ra[a]) {
            for (var b = 0, c = ea(String(qa)).split("."), d = ea(String(a)).split("."), e = Math.max(c.length, d.length), f = 0; 0 == b && f < e; f++) {
                var k = c[f] || "",
                    l = d[f] || "",
                    $a = RegExp("(\\d*)(\\D*)", "g"),
                    ab = RegExp("(\\d*)(\\D*)", "g");
                do {
                    ...
                    b = v(0 == K[1].length ? 0 : parseInt(K[1], 10), 0 == L[1].length ? 0 : parseInt(L[1], 10)) || v(0 == K[2].length, 0 == L[2].length) || v(K[2], L[2])
                } while (0 == b)
            }
            ra[a] = 0 <= b
        }
    ...
    var ta = h.document,
        ua = pa(),
        va = !ta || !C || !ua && B() ? void 0 : ua || ("CSS1Compat" == ta.compatMode ? parseInt(qa, 10) : 5);
    var E;
    if (!(E = !D && !C)) {
        var F;
        if (F = C) F = C && (B() || 9 <= va);
        ...
        switch (typeof b) {
            ...
            case "object":
                ...
                if ("array" == n(b)) {
                    var d = b.length;
                    c.push("[");
                    for (var e = "", f = 0; f < d; f++) c.push(e), G(a, b[f], c), e = ",";
                    c.push("]");
                    break
                }
                c.push("{");
                d = "";
                for (e in b) Object.prototype.hasOwnProperty.call(b, e) && (f = b[e], "function" != typeof f && (c.push(d), Aa(e, c), c.push(":"), G(a, f, c), d = ","));
                c.push("}");
                break;
            case "function":
                break;
    ...
    function Da(a, b) {
        if (0 != a.n) a.f || (a.f = []), a.f.push(b);
        else {
            var c = a.c[b];
            if (c) {
                if (c = a.d[c]) {
                    var d = fa(c, b);
                    0 <= d && w.splice.call(c, d, 1)
                }
                delete a.c[b];
                delete a.c[b + 1];
                delete a.c[b + 2]
    ...
    function Fa(a) {
        if (N) {
            ...
            if (b) {
                var c = b.href;
                if (c && (c = (c = Fa(c)[3] || null) ? decodeURI(c) : c) && c != b.hostname) throw N = !0, Error();
            }
        }
        return a.match(Ea)
    }
    ...
    var Ha = /#|$/;
    var Ia = m("yt.dom.getNextId_");
    if (!Ia) {
        Ia = function() {
            return ++Ja
        };
        t("yt.dom.getNextId_", Ia);
        var Ja = 0
    };
    var O = window.yt && window.yt.config_ || window.ytcfg && window.ytcfg.data_ || {};
    t("yt.config_", O);
    ...
    function Na(a, b) {
        ...
        c ? c(a, b) : (c = ("ERRORS" in O ? O.ERRORS : void 0) || [], c.push([a, b]), Ka("ERRORS", c))
    };

    function Oa(a) {
        if (a = a || window.event) {
            for (var b in a) b in Pa || (this[b] = a[b]);
    ...
    var Qa = m("yt.events.counter_") || {
        count: 0
    };
    t("yt.events.counter_", Qa);
    ...
    function Q(a, b) {
        return "yt:" == a.tagName.toLowerCase().substr(0, 3) ? a.getAttribute(b) : a ? a.dataset ? a.dataset[Wa(b)] : a.getAttribute("data-" + b) : null
    }

    function cb(a, b) {
        M.I.apply(M, arguments)
    };

    function R(a, b, c) {
        this.d = b;
        this.h = this.c = null;
        this.A = this[q] || (this[q] = ++ba);
        this.e = 0;
        this.v = !1;
        this.o = [];
        this.f = null;
        ...
        if (a = p(a) ? b.getElementById(a) : a)
            if ("iframe" != a.tagName.toLowerCase() && (b = db(this, a), this.h = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.c = a, this.c.id || (b = a = this.c, b = b[q] || (b[q] = ++ba), a.id = "widget" + b), P[this.c.id] = this, window.postMessage) {
                this.f = new J;
                eb(this);
                a = S(this.d, "events");
                for (var d in a) a.hasOwnProperty(d) && this.addEventListener(d, a[d]);
                for (var e in Ya) fb(this,
                    e)
            }
    }
    g = R.prototype;
    ...
    function db(a, b) {
        ...
        c.setAttribute("title", "YouTube " + S(a.d, "title"));
        (d = S(a.d, "width")) && c.setAttribute("width", d);
        (d = S(a.d, "height")) && c.setAttribute("height", d);
        var l = a.m();
        ...
        c.src = S(a.d, "host") + a.r() + "?" + Ua(l);
        return c
    }
    g.H = function() {
        this.c && this.c.contentWindow ? this.B({
            event: "listening"
    ...
    function eb(a) {
        hb(a.d, a, a.A);
        a.e = La(r(a.H, a));
        Sa(a.c, "load", r(function() {
            window.clearInterval(this.e);
            this.e = La(r(this.H, this))
        }, a))
    }

    function gb(a, b) {
        a.G[b] || (a.G[b] = !0, U(a, "addEventListener", [b]))
    }
    g.B = function(a) {
        a.id = this.A;
        var b = [];
        ...
        f && (k += "//", e && (k += e + "@"), k += f, d && (k += ":" + d));
        c = k;
        b = 0 == c.indexOf("https:") ? [c] : b.c ? [c.replace("http:", "https:")] : b.e ? [c] : [c, c.replace("http:", "https:")];
        for (c = 0; c < b.length; c++) try {
            this.c.contentWindow.postMessage(a, b[c])
        } catch (l) {
            if (l.name && "SyntaxError" == l.name) Na(l, "WARNING");
            else throw l;
        }
    };
    var ib = "StopIteration" in h ? h.StopIteration : Error("StopIteration");
    ...
    function hb(a, b, c) {
        T || (T = {}, Sa(window, "message", r(a.f, a)));
        T[c] = b
    }
    W.prototype.f = function(a) {
        var b;
        (b = a.origin == S(this, "host")) || ((b = a.origin) && b == rb ? b = !0 : (new RegExp("^(https?:)?//([a-z0-9-]{1,63}\\.)*(" + qb.join("|").replace(/\./g, ".") + ")(:[0-9]+)?([/?#]|$)", "i")).test(b) ? (rb = b, b = !0) : b = !1);
        if (b) {
            var c;
            try {
                c = ya(a.data)
            ...
            if (a = T[c.id]) a.v = !0, a.v && (x(a.o, a.B, a), a.o.length = 0), a.J(c)
        }
    };
    ...
    g = X.prototype;
    g.r = function() {
        return "/embed/" + S(this.d, "videoId")
    };
    g.m = function() {
        var a;
        if (S(this.d, "playerVars")) {
            a = S(this.d, "playerVars");
            var b = {}, c;
            for (c in a) b[c] = a[c];
            a = b
        } else a = {};
    ...
    function vb(a, b) {
        x(b, function(a) {
            this[a] || (ob(a) ? this[a] = function() {
                this.l = {};
                this.j = {};
                U(this, a, arguments);
                return this
            } : pb(a) ? this[a] = function() {
                var b = 0;
    ...
    Y.prototype.m = function() {
        return {
            player: 0,
            thumb_width: S(this.d, "thumbWidth"),
            thumb_height: S(this.d, "thumbHeight"),
            thumb_align: S(this.d, "thumbAlign")
        }
    };
    Y.prototype.k = function(a, b) {
        Y.C.k.call(this, a, b ? b.info : void 0)
    };
    ...
    R.prototype.setSize = R.prototype.R;
    R.prototype.getIframe = R.prototype.Q;
    ...
    "undefined" != typeof YTConfig && YTConfig.parsetags && "onload" != YTConfig.parsetags || Za();
    var zb = m("onYTReady");
    zb && zb();
    var Ab = m("onYouTubeIframeAPIReady");
    Ab && Ab();
    var Bb = m("onYouTubePlayerAPIReady");
    Bb && Bb();
})();
